...
//    TWLoadingView *loadingView = [TWLoadingView loadingViewDefaultWithFrame:CGRectMake(0, 200, 150, 150)];
    TWLoadingView *loadingView = [TWLoadingView loadingViewWithFrame:CGRectMake(0, 200, 150, 150) circleColor:nil circleWidth:0.0 circleBorderWidth:0.0 withTipText:nil tipFont:nil tipColor:nil];
